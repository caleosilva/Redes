...
def handle_client(client_socket):
    try:
        ...
        while True:
            ...
            elif (dataJson['header'] == 'limparCaixa'):
                solicitarLimpezaCarrinho(idCaixa)
...
def solicitarLimpezaCarrinho(idCaixa):
    try:
        response = requests.post(server_host + 'limparCarrinho' + '/' + idCaixa, json={})
